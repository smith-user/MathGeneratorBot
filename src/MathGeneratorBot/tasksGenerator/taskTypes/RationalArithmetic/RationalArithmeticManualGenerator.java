...
import static MathGeneratorBot.tasksGenerator.mathClasses.MathFunctions.*;

import java.util.Objects;

final public class RationalArithmeticManualGenerator extends RationalArithmeticGenerator {

    private static final Logger logger = LogManager.getLogger(RationalArithmeticManualGenerator.class.getName());
